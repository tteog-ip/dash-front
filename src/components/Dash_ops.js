        ...
        <div className="dashboard-main-wrapper">
            ...
            <div className="dashboard-header">
                <nav className="navbar navbar-expand-lg bg-white fixed-top">
                    <a className="navbar-brand" href="/dash_ops">TTeog-Ip</a>
                        ...
                        <div className="collapse navbar-collapse" id="navbarNav">
                            <ul className="navbar-nav flex-column">
                                ...
                                <li className="nav-item">
                                    <a className="nav-link" href="/dash_ops"><i
                                        className="fas fa-fw fa-chart-pie"></i>Operator</a>
                                </li>
                            </ul>
                        </div>
                    </nav>
                                ...
                                <div className="page-breadcrumb">
                                    <nav aria-label="breadcrumb">
                                        <ol className="breadcrumb">
                                            <li className="breadcrumb-item"><a href="/dash_ops"
                                                                               className="breadcrumb-link">Dashboard</a>
                                            </li>
                                            <li className="breadcrumb-item active" aria-current="page">Operator
                                                Dashboard
                                            </li>
                                        </ol>
                                    </nav>
